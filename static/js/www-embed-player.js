...
(null==(h=a)?void 0:h.id)){m.u(6);break}return v(m,xo(a.id,b,!1),6);case 6:return m.return();case 2:if(M("nwl_consider_error_code")&&!g&&sp()>Fk("potential_esf_error_limit",10))return m.return();B("ytNetworklessLoggingInitializationOptions")&&ep.potentialEsfErrorCounter++;cp++;if(void 0===(null==(k=a)?void 0:k.id)){m.u(8);break}return 1>a.sendCount?v(m,xo(a.id,b),12):v(m,yo(a.id,b),8);case 12:Vh.S(function(){hp().L()&&ip()},5E3);
case 8:c(e,f),m.i=0}})};
...
;function Gp(a){var b=this;this.config_=null;a?this.config_=a:Ll()&&(this.config_=Ml());dm(function(){am(b)},0,5E3)}
Gp.prototype.isReady=function(){!this.config_&&Ll()&&(this.config_=Ml());return!!this.config_};
...
Fq.prototype.storePayload=function(a,b){this.store.push({payload:b,keys:a});b=Gq(a);this.i[b]?this.i[b]++:this.i[b]=1;this.i[b]>=this.policy.maxBatchSize&&(this.policy.onBatchSizeExceeded(a),this.i[b]=0);return b};
Fq.prototype.extractMatchingEntries=function(a){for(var b=[],c=[],d=p(this.store),e=d.next();!e.done;e=d.next()){e=e.value;a:{var f=a;var g=Object.keys(f);g=p(g);for(var h=g.next();!h.done;h=g.next())if(h=h.value,e.keys[h]!==f[h]){f=!1;break a}f=!0}f?(b.push(e.payload),this.i[Gq(e.keys)]--):c.push(e)}this.store=c;a=Hq(this,a);a=p(a);for(c=a.next();!c.done;c=a.next())c=c.value,0<this.i[c]&&Mk(new Q("Transport IMS did not fully extract entries for key:",{sequence:c,Oq:b.length,Nq:this.i[c]}));return b};
...
function Vq(){var a=B("yt.logging.ims");a||(a=new Fq({maxBatchSize:Fk("tvhtml5_logging_max_batch")||Fk("web_logging_max_batch")||100,onBatchSizeExceeded:function(b){Wq({writeThenSend:!0},void 0,b.isJspb)}}),z("yt.logging.ims",a));
return a}
function Xq(a,b){M("web_all_payloads_via_jspb")&&Mk(new Q("transport.log called for JSON in JSPB only experiment"));if("log_event"===a.endpoint){Yq(a);var c=Zq(a);if(M("use_new_in_memory_storage")){Uq[c]=!0;var d={cttAuthInfo:c,isJspb:!1};Vq().storePayload(d,a.payload);$q(b,[],c,!1,d)}else d=Qq.get(c)||[],Qq.set(c,d),d.push(a.payload),$q(b,d,c)}}
function ar(a,b){if("log_event"===a.endpoint){Yq(void 0,a);var c=Zq(a,!0);if(M("use_new_in_memory_storage")){Uq[c]=!0;var d={cttAuthInfo:c,isJspb:!0};Vq().storePayload(d,a.payload.toJSON());$q(b,[],c,!0,d)}else d=Rq.get(c)||[],Rq.set(c,d),a=a.payload.toJSON(),d.push(a),$q(b,d,c,!0)}}
function $q(a,b,c,d,e){d=void 0===d?!1:d;a&&(Lq=new a);a=Fk("tvhtml5_logging_max_batch")||Fk("web_logging_max_batch")||100;var f=P(),g=d?Oq.l:Nq.l;b=b.length;e&&(b=Vq().getSequenceCount(e));b>=a?Wq({writeThenSend:!0},M("flush_only_full_queue")?c:void 0,d):10<=f-g&&(br(d),d?Oq.l=f:Nq.l=f)}
function cr(a,b){M("web_all_payloads_via_jspb")&&Mk(new Q("transport.logIsolatedGelPayload called in JSPB only experiment"));if("log_event"===a.endpoint){Yq(a);var c=Zq(a),d=new Map;d.set(c,[a.payload]);b&&(Lq=new b);return new wf(function(e,f){Lq&&Lq.isReady()?dr(d,Lq,e,f,{bypassNetworkless:!0},!0):e()})}}
function er(a,b){if("log_event"===a.endpoint){Yq(void 0,a);var c=Zq(a,!0),d=new Map;d.set(c,[a.payload.toJSON()]);b&&(Lq=new b);return new wf(function(e){Lq&&Lq.isReady()?fr(d,Lq,e,{bypassNetworkless:!0},!0):e()})}}
function Zq(a,b){var c="";if(a.Ea)c="visitorOnlyApprovedKey";else if(a.cttAuthInfo){if(void 0===b?0:b){b=a.cttAuthInfo.token;c=a.cttAuthInfo;var d=new ok;c.videoId?d.setVideoId(c.videoId):c.playlistId&&Sd(d,2,pk,c.playlistId);Tq[b]=d}else b=a.cttAuthInfo,c={},b.videoId?c.videoId=b.videoId:b.playlistId&&(c.playlistId=b.playlistId),Sq[a.cttAuthInfo.token]=c;c=a.cttAuthInfo.token}return c}
function Wq(a,b,c){a=void 0===a?{}:a;c=void 0===c?!1:c;!c&&M("web_all_payloads_via_jspb")&&Mk(new Q("transport.flushLogs called for JSON in JSPB only experiment"));new wf(function(d,e){c?(fl(Oq.j),fl(Oq.i),Oq.i=0):(fl(Nq.j),fl(Nq.i),Nq.i=0);if(Lq&&Lq.isReady())if(M("use_new_in_memory_storage")){var f=a,g=c,h=Lq;f=void 0===f?{}:f;g=void 0===g?!1:g;var k=new Map,m=new Map;if(void 0!==b)g?(e=Vq().extractMatchingEntries({isJspb:g,cttAuthInfo:b}),k.set(b,e),fr(k,h,d,f)):(k=Vq().extractMatchingEntries({isJspb:g,
...
function br(a){a=void 0===a?!1:a;if(M("web_gel_timeout_cap")&&(!a&&!Nq.i||a&&!Oq.i)){var b=el(function(){Wq({writeThenSend:!0},void 0,a)},6E4);
a?Oq.i=b:Nq.i=b}fl(a?Oq.j:Nq.j);b=L("LOGGING_BATCH_TIMEOUT",Fk("web_gel_debounce_ms",1E4));M("shorten_initial_gel_batch_timeout")&&Pq&&(b=Jq);b=el(function(){Wq({writeThenSend:!0},void 0,a)},b);
a?Oq.j=b:Nq.j=b}
...
try{bm(b,"log_event",k,jr(e,m,q,r,f)),Pq=!1}catch(x){Lk(x),d()}}}
function fr(a,b,c,d,e){d=void 0===d?{}:d;var f=Math.round(P()),g=a.size,h=new Map([].concat(ia(a)));h=p(h);for(var k=h.next();!k.done;k=h.next()){var m=p(k.value).next().value,q=a.get(m);k=new qk;var r=Sl(b.config_||Ml());G(k,Yi,1,r);q=q?kr(q):[];q=p(q);for(r=q.next();!r.done;r=q.next())Zd(k,3,Qj,r.value);(q=Tq[m])&&lr(k,m,q);delete Tq[m];m="visitorOnlyApprovedKey"===m;mr(k,f,m);ir(d);k=be(k);m=jr(d,m,function(){g--;g||c()},function(){g--;
g||c()},e);
...
function jr(a,b,c,d,e){a={retry:!0,onSuccess:c,onError:d,Yb:a,Ea:b,Eq:!!e,headers:{},postBodyFormat:"",postBody:""};M("use_request_time_ms_header")&&(a.headers["X-Goog-Request-Time"]=JSON.stringify(Math.round(P())));return a}
...
function pr(a,b,c,d){d=void 0===d?{}:d;var e={},f=Math.round(d.timestamp||P());e.eventTimeMs=f<Number.MAX_SAFE_INTEGER?f:0;e[a]=b;M("enable_unknown_lact_fix_on_html5")&&rq();a=uq();e.context={lastActivityMs:String(d.timestamp||!isFinite(a)?-1:a)};M("log_sequence_info_on_gel_web")&&d.ba&&(a=e.context,b=d.ba,b={index:qr(b),groupKey:b},a.sequence=b,d.Qb&&delete or[d.ba]);(d.ic?cr:Xq)({endpoint:"log_event",payload:e,cttAuthInfo:d.cttAuthInfo,Ea:d.Ea},c)}
function rr(a){Wq(void 0,void 0,void 0===a?!1:a)}
function qr(a){or[a]=a in or?or[a]+1:0;return or[a]}
;var sr=y.ytLoggingGelSequenceIdObj_||{};z("ytLoggingGelSequenceIdObj_",sr);function tr(a,b,c){c=void 0===c?{}:c;var d=Math.round(c.timestamp||P());D(a,1,d<Number.MAX_SAFE_INTEGER?d:0);var e=uq();d=new Pj;D(d,1,c.timestamp||!isFinite(e)?-1:e);if(M("log_sequence_info_on_gel_web")&&c.ba){e=c.ba;var f=qr(e),g=new Oj;D(g,2,f);D(g,1,e);G(d,Oj,3,g);c.Qb&&delete sr[c.ba]}G(a,Pj,33,d);(c.ic?er:ar)({endpoint:"log_event",payload:a,cttAuthInfo:c.cttAuthInfo,Ea:c.Ea},b)}
;function ur(a,b){b=void 0===b?{}:b;var c=!1;L("ytLoggingEventsDefaultDisabled",!1)&&(c=!0);tr(a,c?null:Gp,b)}
...
;function sm(a,b,c){c=void 0===c?{}:c;if(M("migrate_events_to_ts")){c=void 0===c?{}:c;var d=Gp;L("ytLoggingEventsDefaultDisabled",!1)&&Gp===Gp&&(d=null);M("web_all_payloads_via_jspb")&&Mk(new Q("Logs should be translated to JSPB but are sent as JSON instead",a));pr(a,b,d,c)}else d=Gp,L("ytLoggingEventsDefaultDisabled",!1)&&Gp==Gp&&(d=null),pr(a,b,d,c)}
...
Za:{ReferenceError:[{regexp:/(.*) is not defined/,groups:["key"]},{regexp:/Can't find variable: (.*)/,groups:["key"]}]}}];var Er={na:[],ma:[{callback:Dr,weight:500}]};function Dr(a){if("JavaException"===a.name)return!0;a=a.stack;return a.includes("chrome://")||a.includes("chrome-extension://")||a.includes("moz-extension://")}
;function Fr(){this.ma=[];this.na=[]}
var Gr;function Hr(){if(!Gr){var a=Gr=new Fr;a.na.length=0;a.ma.length=0;Er.na&&a.na.push.apply(a.na,Er.na);Er.ma&&a.ma.push.apply(a.ma,Er.ma)}return Gr}
...
k.push("File name: "+a.fileName);k.push("Stacktrace: "+a.stack);window.console.log(k.join("\n"),a)}if(!(5<=Pr)){var m=Sr,q=se(a),r=q.message||"Unknown Error",x=q.name||"UnknownError",u=q.stack||a.j||"Not available";if(u.startsWith(x+": "+r)){var A=u.split("\n");A.shift();u=A.join("\n")}var E=q.lineNumber||"Not available",F=q.fileName||"Not available",O=u,N=0;if(a.hasOwnProperty("args")&&a.args&&a.args.length)for(var R=0;R<a.args.length&&!(N=Lr(a.args[R],"params."+R,g,N),500<=N);R++);else if(a.hasOwnProperty("params")&&
a.params){var ca=a.params;if("object"===typeof a.params)for(var W in ca){if(ca[W]){var ob="params."+W,Ya=Nr(ca[W]);g[ob]=Ya;N+=ob.length+Ya.length;if(500<N)break}}else g.params=Nr(ca)}if(m.length)for(var la=0;la<m.length&&!(N=Lr(m[la],"params.context."+la,g,N),500<=N);la++);navigator.vendor&&!g.hasOwnProperty("vendor")&&(g["device.vendor"]=navigator.vendor);var H={message:r,name:x,lineNumber:E,fileName:F,stack:O,params:g,sampleWeight:1},ka=Number(a.columnNumber);isNaN(ka)||(H.lineNumber=H.lineNumber+
":"+ka);if("IGNORED"===a.level)var ea=0;else a:{for(var Ae=Hr(),Be=p(Ae.na),wd=Be.next();!wd.done;wd=Be.next()){var na=wd.value;if(H.message&&H.message.match(na.Mq)){ea=na.weight;break a}}for(var tp=p(Ae.ma),Sj=tp.next();!Sj.done;Sj=tp.next()){var up=Sj.value;if(up.callback(H)){ea=up.weight;break a}}ea=1}H.sampleWeight=ea;for(var vp=p(Cr),Tj=vp.next();!Tj.done;Tj=vp.next()){var Uj=Tj.value;if(Uj.Za[H.name])for(var wp=p(Uj.Za[H.name]),Vj=wp.next();!Vj.done;Vj=wp.next()){var xp=Vj.value,Qg=H.message.match(xp.regexp);
if(Qg){H.params["params.error.original"]=Qg[0];for(var Wj=xp.groups,yp={},xd=0;xd<Wj.length;xd++)yp[Wj[xd]]=Qg[xd+1],H.params["params.error."+Wj[xd]]=Qg[xd+1];H.message=Uj.tb(yp);break}}}H.params||(H.params={});var zp=Hr();H.params["params.errorServiceSignature"]="msg="+zp.na.length+"&cb="+zp.ma.length;H.params["params.serviceWorker"]="false";y.document&&y.document.querySelectorAll&&(H.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));Db("sample").constructor!==
Bb&&(H.params["params.fconst"]="true");window.yterr&&"function"===typeof window.yterr&&window.yterr(H);if(0!==H.sampleWeight&&!Or.has(H.message)){if("ERROR"===h){Ir.qa("handleError",H);if(M("record_app_crashed_web")&&0===Rr&&1===H.sampleWeight)if(Rr++,M("errors_via_jspb")){var Xj=new pj;D(Xj,1,1);if(!M("report_client_error_with_app_crash_ks")){var Ap=new kj;D(Ap,1,H.message);var Bp=new lj;G(Bp,kj,3,Ap);var Cp=new mj;G(Cp,lj,5,Bp);var Dp=new nj;G(Dp,mj,9,Cp);G(Xj,nj,4,Dp)}var Ep=new Qj;Xd(Ep,pj,20,
Rj,Xj);ur(Ep)}else{var Fp={appCrashType:"APP_CRASH_TYPE_BREAKPAD"};M("report_client_error_with_app_crash_ks")||(Fp.systemHealth={crashData:{clientError:{logMessage:{message:H.message}}}});sm("appCrashed",Fp)}Qr++}else"WARNING"===h&&Ir.qa("handleWarning",H);if(M("kevlar_gel_error_routing"))a:{var Ce=h;if(M("errors_via_jspb")){if(Wr())var Hp=void 0;else{var yd=new hj;D(yd,1,H.stack);H.fileName&&D(yd,4,H.fileName);var Jb=H.lineNumber&&H.lineNumber.split?H.lineNumber.split(":"):[];0!==Jb.length&&(1!==
Jb.length||isNaN(Number(Jb[0]))?2!==Jb.length||isNaN(Number(Jb[0]))||isNaN(Number(Jb[1]))||(D(yd,2,Number(Jb[0])),D(yd,3,Number(Jb[1]))):D(yd,2,Number(Jb[0])));var zc=new kj;D(zc,1,H.message);D(zc,3,H.name);D(zc,6,H.sampleWeight);"ERROR"===Ce?D(zc,2,2):"WARNING"===Ce?D(zc,2,1):D(zc,2,0);var Yj=new ij;D(Yj,1,!0);Xd(Yj,hj,3,jj,yd);var bc=new ej;D(bc,3,window.location.href);for(var Ip=L("FEXP_EXPERIMENTS",[]),Zj=0;Zj<Ip.length;Zj++){var Ov=Ip[Zj];Bd(bc);Pd(bc,5,2,!1).push(Ov)}var ak=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");
if(!Dk()&&ak)for(var Jp=p(Object.keys(ak)),Ac=Jp.next();!Ac.done;Ac=Jp.next()){var Kp=Ac.value,bk=new gj;D(bk,1,Kp);bk.setValue(String(ak[Kp]));Zd(bc,4,gj,bk)}var ck=H.params;if(ck){var Lp=p(Object.keys(ck));for(Ac=Lp.next();!Ac.done;Ac=Lp.next()){var Mp=Ac.value,dk=new gj;D(dk,1,"client."+Mp);dk.setValue(String(ck[Mp]));Zd(bc,4,gj,dk)}}var Np=L("SERVER_NAME"),Op=L("SERVER_VERSION");if(Np&&Op){var ek=new gj;D(ek,1,"server.name");ek.setValue(Np);Zd(bc,4,gj,ek);var fk=new gj;D(fk,1,"server.version");
fk.setValue(Op);Zd(bc,4,gj,fk)}var Rg=new lj;G(Rg,ej,1,bc);G(Rg,ij,2,Yj);G(Rg,kj,3,zc);Hp=Rg}var Pp=Hp;if(!Pp)break a;var Qp=new Qj;Xd(Qp,lj,163,Rj,Pp);ur(Qp)}else{if(Wr())var Rp=void 0;else{var De={stackTrace:H.stack};H.fileName&&(De.filename=H.fileName);var Kb=H.lineNumber&&H.lineNumber.split?H.lineNumber.split(":"):[];0!==Kb.length&&(1!==Kb.length||isNaN(Number(Kb[0]))?2!==Kb.length||isNaN(Number(Kb[0]))||isNaN(Number(Kb[1]))||(De.lineNumber=Number(Kb[0]),De.columnNumber=Number(Kb[1])):De.lineNumber=
Number(Kb[0]));var gk={level:"ERROR_LEVEL_UNKNOWN",message:H.message,errorClassName:H.name,sampleWeight:H.sampleWeight};"ERROR"===Ce?gk.level="ERROR_LEVEL_ERROR":"WARNING"===Ce&&(gk.level="ERROR_LEVEL_WARNNING");var Pv={isObfuscated:!0,browserStackInfo:De},zd={pageUrl:window.location.href,kvPairs:[]};L("FEXP_EXPERIMENTS")&&(zd.experimentIds=L("FEXP_EXPERIMENTS"));var hk=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(!Dk()&&hk)for(var Sp=p(Object.keys(hk)),Bc=Sp.next();!Bc.done;Bc=Sp.next()){var Tp=
Bc.value;zd.kvPairs.push({key:Tp,value:String(hk[Tp])})}var ik=H.params;if(ik){var Up=p(Object.keys(ik));for(Bc=Up.next();!Bc.done;Bc=Up.next()){var Vp=Bc.value;zd.kvPairs.push({key:"client."+Vp,value:String(ik[Vp])})}}var Wp=L("SERVER_NAME"),Xp=L("SERVER_VERSION");Wp&&Xp&&(zd.kvPairs.push({key:"server.name",value:Wp}),zd.kvPairs.push({key:"server.version",value:Xp}));Rp={errorMetadata:zd,stackTrace:Pv,logMessage:gk}}var Yp=Rp;if(!Yp)break a;sm("clientError",Yp)}if("ERROR"===Ce||M("errors_flush_gel_always_killswitch"))b:if(M("migrate_events_to_ts"))c:{if(M("web_fp_via_jspb")&&
...
H.stack);for(var Zp=p(Object.keys(Ee)),jk=Zp.next();!jk.done;jk=Zp.next()){var $p=jk.value;cc.postParams["client."+$p]=Ee[$p]}var kk=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(kk)for(var aq=p(Object.keys(kk)),lk=aq.next();!lk.done;lk=aq.next()){var bq=lk.value;cc.postParams[bq]=kk[bq]}var cq=L("SERVER_NAME"),dq=L("SERVER_VERSION");cq&&dq&&(cc.postParams["server.name"]=cq,cc.postParams["server.version"]=dq)}ll(L("ECATCHER_REPORT_HOST","")+"/error_204",cc)}try{Or.add(H.message)}catch(qx){}Pr++}}}}
...
function Zr(a){a=p(a.register.values());for(var b=a.next();!b.done;b=a.next())b.value.Rq("ABORTED")}
...
return a.join("")}
;var cs=y.ytLoggingDocDocumentNonce_;cs||(cs=bs(),z("ytLoggingDocDocumentNonce_",cs));var ds=cs;var es={Ih:0,ke:1,ue:2,Dl:3,Kh:4,Vp:5,sm:6,co:7,yn:8,Qn:9,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE",8:"PUSH_NOTIFICATIONS",9:"RICH_GRID_WATCH"};function fs(a){this.i=a}
...
function ps(a,b,c,d){c=void 0===c?0:c;if(a!==L(hs(c))||b!==L(is(c)))if(ns(a,d,c),Ck(hs(c),a),Ck(is(c),b),b=function(){setTimeout(function(){if(a)if(M("web_time_via_jspb")){var e=new sj;D(e,1,ds);D(e,2,a);M("use_default_heartbeat_client")?Br(e):Br(e,void 0,Gp)}else e={clientDocumentNonce:ds,clientScreenNonce:a},M("use_default_heartbeat_client")?sm("foregroundHeartbeatScreenAssociated",e):pr("foregroundHeartbeatScreenAssociated",e,Gp)},0)},"requestAnimationFrame"in window)try{window.requestAnimationFrame(b)}catch(e){b()}else b()}
...
cq:55759,fq:64031,lq:93044,mq:93045,nq:34388,oq:17657,pq:17655,qq:39579,rq:39578,sq:77448,tq:8196,uq:11357,wq:69877,xq:8197,yq:156512,zq:156509,Aq:82039};function ts(){var a=vb(us),b;return(new wf(function(c,d){a.onSuccess=function(e){dl(e)?c(new vs(e)):d(new ws("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
...
t(ws,ab);function vs(a){this.xhr=a}
;function xs(){this.i=0;this.ka=null}
xs.prototype.then=function(a,b,c){return 1===this.i&&a?(a=a.call(c,this.ka))&&"function"===typeof a.then?a:ys(a):2===this.i&&b?(a=b.call(c,this.ka))&&"function"===typeof a.then?a:zs(a):this};
xs.prototype.getValue=function(){return this.ka};
xs.prototype.$goog_Thenable=!0;function zs(a){var b=new xs;a=void 0===a?null:a;b.i=2;b.ka=void 0===a?null:a;return b}
function ys(a){var b=new xs;a=void 0===a?null:a;b.i=1;b.ka=void 0===a?null:a;return b}
...
t(vt,$n);var wt=new ao("aft-recorded",vt);var xt=window;function zt(){this.timing={};this.clearResourceTimings=function(){};
...
Wa(S.clearResourceTimings||S.webkitClearResourceTimings||S.mozClearResourceTimings||S.msClearResourceTimings||S.oClearResourceTimings||cb,S);function Ct(a){var b=Dt(a);if(b.aft)return b.aft;a=L((a||"")+"TIMING_AFT_KEYS",["ol"]);for(var c=a.length,d=0;d<c;d++){var e=b[a[d]];if(e)return e}return NaN}
...
function Mt(a){var b=Ht(a).nonce;b||(b=bs(),Ht(a).nonce=b);return b}
function Nt(a){var b=Dt(a||""),c=Ct(a);c&&!At&&(go(wt,new vt(Math.round(c-b._start),a)),At=!0)}
...
;function Pt(){if(S.getEntriesByType){var a=S.getEntriesByType("paint");if(a=kb(a,function(b){return"first-paint"===b.name}))return Ft(a.startTime)}a=S.timing;
...
function Zt(a,b,c){c=Jt(c);if(c.gelInfos)c.gelInfos[a]=!0;else{var d={};c.gelInfos=(d[a]=!0,d)}if(a.match("_rid")){var e=a.split("_rid")[0];a="REQUEST_ID"}if(a in Tt){c=Tt[a];0<=eb(Ut,c)&&(b=!!b);a in Wt&&"string"===typeof b&&(b=Wt[a]+b.toUpperCase());a=b;b=c.split(".");for(var f=d={},g=0;g<b.length-1;g++){var h=b[g];f[h]={};f=f[h]}f[b[b.length-1]]="requestIds"===c?[{id:a,endpoint:e}]:a;return qt({},d)}0<=eb(Xt,a)||Vr(new Q("Unknown label logged with GEL CSI",a))}
...
ju.prototype.tick=function(a,b,c,d){lu(this,"tick_"+a+"_"+b)||(c={timestamp:c,cttAuthInfo:d},M("web_csi_via_jspb")?(d=new Nj,D(d,1,a),D(d,2,b),a=new Qj,Xd(a,Nj,5,Rj,d),ur(a,c)):sm("latencyActionTicked",{tickName:a,clientActionNonce:b},c))};
ju.prototype.info=function(a,b,c){var d=Object.keys(a).join("");lu(this,"info_"+d+"_"+b)||(a=Object.assign({},a),a.clientActionNonce=b,sm("latencyActionInfo",a,{cttAuthInfo:c}))};
ju.prototype.jspbInfo=function(a,b,c){for(var d="",e=0;e<a.toJSON().length;e++)void 0!==a.toJSON()[e]&&(d=0===e?d.concat(""+e):d.concat("_"+e));lu(this,"info_"+d+"_"+b)||(D(a,2,b),b={cttAuthInfo:c},c=new Qj,Xd(c,Jj,7,Rj,a),ur(c,b))};
ju.prototype.span=function(a,b,c){var d=Object.keys(a).join("");lu(this,"span_"+d+"_"+b)||(a.clientActionNonce=b,sm("latencyActionSpan",a,{cttAuthInfo:c}))};
function lu(a,b){iu[b]=iu[b]||{count:0};var c=iu[b];c.count++;c.time=P();a.i||(a.i=dm(function(){var d=P(),e;for(e in iu)iu[e]&&6E4<d-iu[e].time&&delete iu[e];a&&(a.i=0)},0,5E3));
...
;function mu(){var a=["ol"];Rt("").info.actionType="embed";a&&Ck("TIMING_AFT_KEYS",a);Ck("TIMING_ACTION","embed");if(M("web_csi_via_jspb")){a=L("TIMING_INFO",{});var b=new Jj;a=p(Object.entries(a));for(var c=a.next();!c.done;c=a.next()){var d=p(c.value);c=d.next().value;d=d.next().value;switch(c){case "GetBrowse_rid":var e=new Mj;D(e,1,c);D(e,2,String(d));Lj(b,e);break;case "GetGuide_rid":e=new Mj;D(e,1,c);D(e,2,String(d));Lj(b,e);break;case "GetHome_rid":e=new Mj;D(e,1,c);D(e,2,String(d));Lj(b,e);
break;case "GetPlayer_rid":e=new Mj;D(e,1,c);D(e,2,String(d));Lj(b,e);break;case "GetSearch_rid":e=new Mj;D(e,1,c);D(e,2,String(d));Lj(b,e);break;case "GetSettings_rid":e=new Mj;D(e,1,c);D(e,2,String(d));Lj(b,e);break;case "GetTrending_rid":e=new Mj;D(e,1,c);D(e,2,String(d));Lj(b,e);break;case "GetWatchNext_rid":e=new Mj;D(e,1,c);D(e,2,String(d));Lj(b,e);break;case "yt_red":D(b,14,!!d);break;case "yt_ad":D(b,9,!!d)}}nu(b);b=new Jj;b=D(b,25,!0);b=D(b,1,V[Yt(L("TIMING_ACTION"))]);(a=L("PREVIOUS_ACTION"))&&
D(b,13,V[Yt(a)]);(a=L("CLIENT_PROTOCOL"))&&D(b,33,a);(a=L("CLIENT_TRANSPORT"))&&D(b,34,a);(a=ms())&&"UNDEFINED_CSN"!==a&&D(b,4,a);a=ou();1!==a&&-1!==a||D(b,6,!0);a=It();a:{d=Lt();c=[];for(e=0;e<d.length;e++){var f=c,g=f.push;var h=d[e];var k=Jj;if(null==h||""==h)k=new k;else{h=JSON.parse(h);if(!Array.isArray(h))throw Error("Expected to deserialize an Array but got "+Oa(h)+": "+h);ae=h;qd(h);k=new k(h);ae=null}g.call(f,k)}for(d=0;d<c.length;d++)if("cold"===Qd(c[d],3,""))break a}D(b,3,"cold");pu(a);
a=qu();if(0<a.length)for(a=p(a),c=a.next();!c.done;c=a.next())c=c.value,d=new Ij,D(d,1,c),Zd(b,83,Ij,d);nu(b)}else{a=L("TIMING_INFO",{});for(b in a)a.hasOwnProperty(b)&&ru(b,a[b]);b={isNavigation:!0,actionType:Yt(L("TIMING_ACTION"))};if(a=L("PREVIOUS_ACTION"))b.previousAction=Yt(a);if(a=L("CLIENT_PROTOCOL"))b.httpProtocol=a;if(a=L("CLIENT_TRANSPORT"))b.transportProtocol=a;(a=ms())&&"UNDEFINED_CSN"!==a&&(b.clientScreenNonce=a);a=ou();if(1===a||-1===a)b.isVisible=!0;a=It();b.loadType="cold";pu(a);a=
qu();if(0<a.length)for(b.resourceInfo=[],a=p(a),c=a.next();!c.done;c=a.next())b.resourceInfo.push({resourceCache:c.value});su(b)}b=It();a=Kt();if("cold"===b.yt_lt||"cold"===a.loadType){c=Dt();d=Jt();d=d.gelTicks?d.gelTicks:d.gelTicks={};for(var m in c)m in d||Z(m,c[m]);m={};c=!1;d=p(Object.keys(b));for(e=d.next();!e.done;e=d.next())e=e.value,(e=Zt(e,b[e]))&&!Ot(Kt(),e)&&(qt(a,e),qt(m,e),c=!0);c&&su(m)}z("ytglobal.timingready_",!0);m=L("TIMING_ACTION");B("ytglobal.timingready_")&&m&&"_start"in Dt()&&
Ct()&&Nt()}
function ru(a,b,c,d){null!==b&&(It(c)[a]=b,(a=Zt(a,b,c))&&su(a,c,d))}
function su(a,b,c){if(!M("web_csi_via_jspb")||(void 0===c?0:c))c=Rt(b||""),qt(c.info,a),qt(Kt(b),a),c=Mt(b),b=Ht(b).cttAuthInfo,ku().info(a,c,b);else{c=new Jj;var d=Object.keys(a);a=Object.values(a);for(var e=0;e<d.length;e++){var f=d[e];try{switch(f){case "actionType":D(c,1,V[a[e]]);break;case "clientActionNonce":D(c,2,a[e]);break;case "clientScreenNonce":D(c,4,a[e]);break;case "loadType":D(c,3,a[e]);break;case "isPrewarmedLaunch":D(c,92,a[e]);break;case "isFirstInstall":D(c,55,a[e]);break;case "networkType":D(c,
5,$t[a[e]]);break;case "connectionType":D(c,26,X[a[e]]);break;case "detailedConnectionType":D(c,27,Y[a[e]]);break;case "isVisible":D(c,6,a[e]);break;case "playerType":D(c,7,au[a[e]]);break;case "clientPlaybackNonce":D(c,8,a[e]);break;case "adClientPlaybackNonce":D(c,28,a[e]);break;case "previousCpn":D(c,77,a[e]);break;case "targetCpn":D(c,76,a[e]);break;case "isMonetized":D(c,9,a[e]);break;case "isPrerollAllowed":D(c,16,a[e]);break;case "isPrerollShown":D(c,17,a[e]);break;case "adType":D(c,12,a[e]);
break;case "adTypesAllowed":D(c,36,a[e]);break;case "adNetworks":D(c,37,a[e]);break;case "previousAction":D(c,13,V[a[e]]);break;case "isRedSubscriber":D(c,14,a[e]);break;case "serverTimeMs":D(c,15,a[e]);break;case "videoId":c.setVideoId(a[e]);break;case "adVideoId":D(c,20,a[e]);break;case "targetVideoId":D(c,78,a[e]);break;case "adBreakType":D(c,21,bu[a[e]]);break;case "isNavigation":D(c,25,a[e]);break;case "viewportHeight":D(c,29,a[e]);break;case "viewportWidth":D(c,30,a[e]);break;case "screenHeight":D(c,
...
case "appInstallDataAgeMs":D(c,73,a[e]);break;case "latencyActionError":D(c,71,cu[a[e]]);break;case "actionStep":D(c,79,a[e]);break;case "jsHeapSizeLimit":D(c,80,a[e]);break;case "totalJsHeapSize":D(c,81,a[e]);break;case "usedJsHeapSize":D(c,82,a[e]);break;case "sourceVideoDurationMs":D(c,90,a[e]);break;case "videoOutputFrames":D(c,93,a[e]);break;case "isResume":D(c,104,a[e]);break;case "adPrebufferedTimeSecs":D(c,39,a[e]);break;case "isLivestream":D(c,47,a[e]);break;case "liveStreamMode":D(c,91,
du[a[e]]);break;case "adCpn2":D(c,48,a[e]);break;case "adDaiDriftMillis":D(c,49,a[e]);break;case "videoStreamType":D(c,53,eu[a[e]]);break;case "playbackRequiresTap":D(c,56,a[e]);break;case "performanceNavigationTiming":D(c,67,a[e]);break;case "transactionType":D(c,74,fu[a[e]]);break;case "playerRotationType":D(c,101,gu[a[e]]);break;case "allowedPreroll":D(c,10,a[e]);break;case "shownPreroll":D(c,11,a[e]);break;case "getHomeRequestId":D(c,57,a[e]);break;case "getSearchRequestId":D(c,60,a[e]);break;
case "getPlayerRequestId":D(c,61,a[e]);break;case "getWatchNextRequestId":D(c,62,a[e]);break;case "getBrowseRequestId":D(c,63,a[e]);break;case "getLibraryRequestId":D(c,66,a[e]);break;default:hu.includes(f)&&Lk(new Q("Codegen laipb translator asked to translate message field",""+f))}}catch(g){Lk(Error("Codegen laipb translator failed to set "+f))}}nu(c,b)}}
function nu(a,b){Lt(b).push(be(a));Rt(b||"").jspbInfo.push(a);var c=Mt(b);b=Ht(b).cttAuthInfo;ku().jspbInfo(a,c,b)}
function Z(a,b,c){if(!b&&"_"!==a[0]){var d=a;S.mark&&(0==d.lastIndexOf("mark_",0)||(d="mark_"+d),c&&(d+=" ("+c+")"),S.mark(d))}d=Rt(c||"");d.tick[a]=b||P();if(d.callback&&d.callback[a]){d=p(d.callback[a]);for(var e=d.next();!e.done;e=d.next())e=e.value,e()}d=Jt(c);d.gelTicks&&(d.gelTicks[a]=!0);d=Dt(c);e=b||P();d[a]=e;e=Mt(c);var f=Ht(c).cttAuthInfo;if("_start"===a){var g=ku();lu(g,"baseline_"+e)||(b={timestamp:b,cttAuthInfo:f},M("web_csi_via_jspb")?(f=new Hj,D(f,1,e),e=new Qj,Xd(e,Hj,6,Rj,f),ur(e,
b)):sm("latencyActionBaselined",{clientActionNonce:e},b))}else ku().tick(a,e,b,f);Nt(c);return d[a]}
function tu(){var a=Mt();requestAnimationFrame(function(){setTimeout(function(){a===Mt()&&Z("ol",void 0,void 0)},0)})}
function ou(){var a=document;if("visibilityState"in a)a=a.visibilityState;else{var b=fq+"VisibilityState";a=b in a?a[b]:void 0}switch(a){case "hidden":return 0;case "visible":return 1;case "prerender":return 2;case "unloaded":return 3;default:return-1}}
function pu(a){var b=Et(),c=Gt(),d=L("CSI_START_TIMESTAMP_MILLIS",0);0<d&&!M("embeds_web_enable_csi_start_override_killswitch")&&(c=d);c&&(Z("srt",b.responseStart),1!==a.prerender&&Z("_start",c,void 0));a=Pt();0<a&&Z("fpt",a);a=Et();a.isPerformanceNavigationTiming&&su({performanceNavigationTiming:!0});Z("nreqs",a.requestStart,void 0);Z("nress",a.responseStart,void 0);Z("nrese",a.responseEnd,void 0);0<a.redirectEnd-a.redirectStart&&(Z("nrs",a.redirectStart,void 0),Z("nre",a.redirectEnd,void 0));0<
a.domainLookupEnd-a.domainLookupStart&&(Z("ndnss",a.domainLookupStart,void 0),Z("ndnse",a.domainLookupEnd,void 0));0<a.connectEnd-a.connectStart&&(Z("ntcps",a.connectStart,void 0),Z("ntcpe",a.connectEnd,void 0));a.secureConnectionStart>=Gt()&&0<a.connectEnd-a.secureConnectionStart&&(Z("nstcps",a.secureConnectionStart,void 0),Z("ntcpe",a.connectEnd,void 0));S&&"getEntriesByType"in S&&uu()}
...
function qu(){var a=[];if(document.querySelector&&S&&S.getEntriesByName)for(var b in Bt)if(Bt.hasOwnProperty(b)){var c=Bt[b];vu(b,c)&&a.push(c)}return a}
...
function Au(a,b,c,d){if(void 0!==zu.i){if(d=zu.i,a=[a!==d.o,b!==d.M,c!==d.m,!1,!1,void 0!==d.j],a.some(function(e){return e}))throw new Q("InnerTubeTransportService is already initialized",a);
}else zu.i=new zu(a,b,c,d)}
function Bu(a){var b={signalServiceEndpoint:{signal:"GET_DATASYNC_IDS"}};var c=void 0===c?Ps:c;var d=Ys(b,a.o);if(!d)return Bf(new Q("Error: No request builder found for command.",b));var e=d.o(b,void 0,c);return e?new wf(function(f){var g,h,k;return w(function(m){if(1==m.i){h="cors"===(null==(g=e.ta)?void 0:g.mode)?"cors":void 0;if(a.m.md){var q=e.config,r;q=null==q?void 0:null==(r=q.Pa)?void 0:r.sessionIndex;r=Os({sessionIndex:q});k=Object.assign({},Cu(h),r);return m.u(2)}return v(m,Du(e.config,
h),3)}2!=m.i&&(k=m.j);f(Eu(a,e,k));m.i=0})}):Bf(new Q("Error: Failed to build request for command.",b))}
function Fu(a,b,c){var d;if(b&&!(null==b?0:null==(d=b.Vq)?0:d.Yq)&&a.l){d=p(xu);for(var e=d.next();!e.done;e=d.next())e=e.value,a.l[e]&&a.l[e].handleResponse(b,c)}}
function Eu(a,b,c){var d,e,f,g,h,k,m,q,r,x,u,A,E,F,O,N,R,ca,W,ob,Ya,la,H,ka,ea,Ae,Be,wd;return w(function(na){switch(na.i){case 1:na.u(2);break;case 3:if((d=na.j)&&!d.isExpired())return na.return(Promise.resolve(d.i()));case 2:if(null==(e=b)?0:null==(f=e.ha)?0:f.context)for(g=p([]),h=g.next();!h.done;h=g.next())k=h.value,k.Qq(b.ha.context);if(null==(m=a.j)||!m.Wq(b.input,b.ha)){na.u(4);break}return v(na,a.j.Lq(b.input,b.ha),5);case 5:return q=na.j,M("kevlar_process_local_innertube_responses_killswitch")||
Fu(a,q,b),na.return(q);case 4:return(u=null==(x=b.config)?void 0:x.Aa)&&a.i.has(u)&&M("web_memoize_inflight_requests")?r=a.i.get(u):(A=JSON.stringify(b.ha),O=null!=(F=null==(E=b.ta)?void 0:E.headers)?F:{},b.ta=Object.assign({},b.ta,{headers:Object.assign({},O,c)}),N=Object.assign({},b.ta),"POST"===b.ta.method&&(N=Object.assign({},N,{body:A})),(null==(R=b.config)?0:R.Xc)&&Z(b.config.Xc),ca=function(){return a.M.fetch(b.input,N,b.config)},r=ca(),u&&a.i.set(u,r)),v(na,r,6);
case 6:W=na.j;if(M("web_one_platform_error_handling")&&(null==(ob=W)?0:null==(Ya=ob.error)?0:Ya.details))for(la=W.error.details,H=p(la),ka=H.next();!ka.done;ka=H.next())ea=ka.value,(Ae=ea["@type"])&&-1<yu.indexOf(Ae)&&(delete ea["@type"],W=ea);u&&a.i.has(u)&&a.i.delete(u);(null==(Be=b.config)?0:Be.Yc)&&Z(b.config.Yc);if(W||null==(wd=a.j)||!wd.Fq(b.input,b.ha)){na.u(7);break}return v(na,a.j.Kq(b.input,b.ha),8);case 8:W=na.j;case 7:return Fu(a,W,b),na.return(W)}})}
function Du(a,b){var c,d,e,f;return w(function(g){if(1==g.i){e=null==(c=a)?void 0:null==(d=c.Pa)?void 0:d.sessionIndex;var h=Os({sessionIndex:e});if(!(h instanceof wf)){var k=new wf(cb);xf(k,2,h);h=k}return v(g,h,2)}f=g.j;return g.return(Promise.resolve(Object.assign({},Cu(b),f)))})}
...
;var Gu=new $s("INNERTUBE_TRANSPORT_TOKEN");var Hu=["share/get_web_player_share_panel"],Iu=["feedback"],Ju=["notification/modify_channel_preference"],Ku=["browse/edit_playlist"],Lu=["subscription/subscribe"],Mu=["subscription/unsubscribe"];function Nu(){}
t(Nu,mt);Nu.prototype.l=function(){return Lu};
Nu.prototype.i=function(a){return As(a,wk)||void 0};
...
t(Ou,mt);Ou.prototype.l=function(){return Mu};
Ou.prototype.i=function(a){return As(a,vk)||void 0};
...
t(Pu,mt);Pu.prototype.l=function(){return Iu};
Pu.prototype.i=function(a){return As(a,dj)||void 0};
...
t(Qu,mt);Qu.prototype.l=function(){return Ju};
Qu.prototype.i=function(a){return As(a,uk)||void 0};
Qu.prototype.j=function(a,b){b.params&&(a.params=b.params);b.secondaryParams&&(a.secondaryParams=b.secondaryParams)};function Ru(){}
t(Ru,mt);Ru.prototype.l=function(){return Ku};
Ru.prototype.i=function(a){return As(a,tk)||void 0};
...
t(Su,mt);Su.prototype.l=function(){return Hu};
Su.prototype.i=function(a){return As(a,sk)};
Su.prototype.j=function(a,b,c){c=void 0===c?{}:c;b.serializedShareEntity&&(a.serializedSharedEntity=b.serializedShareEntity);c.includeListId&&(a.includeListId=!0)};var bt=new $s("NETWORK_SLI_TOKEN");function Tu(a){this.i=a}
...
return b};
Tu[Zs]=[new at];var Uu=new $s("NETWORK_MANAGER_TOKEN");var Vu;function Wu(a){$n.call(this,1,arguments);this.csn=a}
t(Wu,$n);var jo=new ao("screen-created",Wu),Xu=[],Zu=Yu,$u=0;function av(a,b,c,d,e,f,g){function h(){Vr(new Q("newScreen() parent element does not have a VE - rootVe",b))}
var k=Zu();f=new fs({veType:b,youtubeData:f,jspbYoutubeData:void 0});e={cttAuthInfo:e,ba:k};if(M("il_via_jspb")){var m=new wj;m.V(k);xj(m,f.getAsJspb());c&&c.visualElement?(f=new yj,c.clientScreenNonce&&D(f,2,c.clientScreenNonce),zj(f,c.visualElement.getAsJspb()),g&&D(f,4,mk[g]),G(m,yj,5,f)):c&&h();d&&D(m,3,d);zr(m,e,a)}else f={csn:k,pageVe:f.getAsJson()},c&&c.visualElement?(f.implicitGesture={parentCsn:c.clientScreenNonce,gesturedVe:c.visualElement.getAsJson()},g&&(f.implicitGesture.gestureType=
g)):c&&h(),d&&(f.cloneCsn=d),a?pr("screenCreated",f,a,e):sm("screenCreated",f,e);go(jo,new Wu(k));return k}
function bv(a,b,c,d){var e=d.filter(function(k){k.csn!==b?(k.csn=b,k=!0):k=!1;return k}),f={cttAuthInfo:os(b),
ba:b};d=p(d);for(var g=d.next();!g.done;g=d.next())g=g.value.getAsJson(),(rb(g)||!g.trackingParams&&!g.veType)&&Vr(Error("Child VE logged with no data"));if(M("il_via_jspb")){var h=new Aj;h.V(b);Cj(h,c.getAsJspb());hb(e,function(k){k=k.getAsJspb();Zd(h,3,rj,k)});
"UNDEFINED_CSN"==b?cv("visualElementAttached",h,f):Ar(h,f,a)}else c={csn:b,parentVe:c.getAsJson(),childVes:hb(e,function(k){return k.getAsJson()})},"UNDEFINED_CSN"==b?cv("visualElementAttached",c,f):a?pr("visualElementAttached",c,a,f):sm("visualElementAttached",c,f)}
function Yu(){for(var a=Math.random()+"",b=[],c=0,d=0;d<a.length;d++){var e=a.charCodeAt(d);255<e&&(b[c++]=e&255,e>>=8);b[c++]=e}return dd(b,3)}
function cv(a,b,c){Xu.push({payloadName:a,payload:b,options:c});$u||($u=ko())}
function lo(a){if(Xu){for(var b=p(Xu),c=b.next();!c.done;c=b.next())if(c=c.value,c.payload)if(M("il_via_jspb"))switch(c.payload.V(a.csn),c.payloadName){case "screenCreated":zr(c.payload,c.options);break;case "visualElementAttached":Ar(c.payload,c.options);break;case "visualElementShown":vr(c.payload,c.options);break;case "visualElementHidden":wr(c.payload,c.options);break;case "visualElementGestured":xr(c.payload,c.options);break;case "visualElementStateChanged":yr(c.payload,c.options);break;default:Vr(new Q("flushQueue unable to map payloadName to JSPB setter"))}else c.payload.csn=
a.csn,pr(c.payloadName,c.payload,null,c.options);Xu.length=0}$u=0}
...
Na(dv);function ev(){this.o=[];this.N=[];this.i=[];this.m=[];this.B=[];this.j=new Set;this.A=new Map}
ev.prototype.s=function(a){this.client=a};
function fv(a,b,c){c=void 0===c?0:c;b.then(function(d){a.j.has(c)&&a.l&&a.l();var e=ms(c),f=ks(c);if(e&&f){var g;(null==d?0:null==(g=d.response)?0:g.trackingParams)&&bv(a.client,e,f,[gs(d.response.trackingParams)]);var h;(null==d?0:null==(h=d.playerResponse)?0:h.trackingParams)&&bv(a.client,e,f,[gs(d.playerResponse.trackingParams)])}})}
function gv(a,b,c,d){d=void 0===d?0:d;if(a.j.has(d))a.o.push([b,c]);else{var e=ms(d);c=c||ks(d);e&&c&&bv(a.client,e,c,[b])}}
ev.prototype.clickCommand=function(a,b,c){var d=a.clickTrackingParams;c=void 0===c?0:c;if(d)if(c=ms(void 0===c?0:c)){a=this.client;var e=gs(d);d={cttAuthInfo:os(c),ba:c};if(M("il_via_jspb")){var f=new Dj;f.V(c);e=e.getAsJspb();G(f,rj,2,e);D(f,4,mk.INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK);b&&G(f,uj,3);"UNDEFINED_CSN"==c?cv("visualElementGestured",f,d):xr(f,d,a)}else f={csn:c,ve:e.getAsJson(),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"},b&&(f.clientData=b),"UNDEFINED_CSN"==c?
cv("visualElementGestured",f,d):a?pr("visualElementGestured",f,a,d):sm("visualElementGestured",f,d);b=!0}else b=!1;else b=!1;return b};
function hv(a,b,c){c=void 0===c?{}:c;a.j.add(c.layer||0);a.l=function(){iv(a,b,c);var f=ks(c.layer);if(f){for(var g=p(a.o),h=g.next();!h.done;h=g.next())h=h.value,gv(a,h[0],h[1]||f,c.layer);f=p(a.N);for(g=f.next();!g.done;g=f.next()){var k=g.value;g=void 0;g=void 0===g?0:g;h=ms(g);var m=k[0]||ks(g);if(h&&m){g=a.client;var q=k[1];k={cttAuthInfo:os(h),ba:h};M("il_via_jspb")?(q=new Gj,q.V(h),m=m.getAsJspb(),G(q,rj,2,m),"UNDEFINED_CSN"==h?cv("visualElementStateChanged",q,k):yr(q,k,g)):(m={csn:h,ve:m.getAsJson(),
clientData:q},"UNDEFINED_CSN"==h?cv("visualElementStateChanged",m,k):g?pr("visualElementStateChanged",m,g,k):sm("visualElementStateChanged",m,k))}}}};
ms(c.layer)||a.l();if(c.Pb)for(var d=p(c.Pb),e=d.next();!e.done;e=d.next())fv(a,e.value,c.layer);else Ur(Error("Delayed screen needs a data promise."))}
function iv(a,b,c){c=void 0===c?{}:c;c.layer||(c.layer=0);var d=void 0!==c.Tc?c.Tc:c.layer;var e=ms(d);d=ks(d);var f;d&&(void 0!==c.parentCsn?f={clientScreenNonce:c.parentCsn,visualElement:d}:e&&"UNDEFINED_CSN"!==e&&(f={clientScreenNonce:e,visualElement:d}));var g,h=L("EVENT_ID");"UNDEFINED_CSN"===e&&h&&(g={servletData:{serializedServletEventId:h}});try{var k=av(a.client,b,f,c.Ob,c.cttAuthInfo,g,c.Iq)}catch(m){Xr(m,{Tq:b,rootVe:d,parentVisualElement:void 0,Gq:e,Pq:f,Ob:c.Ob});Ur(m);return}ps(k,b,
c.layer,c.cttAuthInfo);if(b=e&&"UNDEFINED_CSN"!==e&&d){a:{b=p(Object.values(es));for(f=b.next();!f.done;f=b.next())if(ms(f.value)===e){b=!0;break a}b=!1}b=!b}b&&(b=a.client,g=!0,h=(g=void 0===g?!1:g)?16:8,f={cttAuthInfo:os(e),ba:e,Qb:g},M("il_via_jspb")?(h=new Ej,h.V(e),d=d.getAsJspb(),G(h,rj,2,d),D(h,4,g?16:8),"UNDEFINED_CSN"==e?cv("visualElementHidden",h,f):wr(h,f,b)):(d={csn:e,ve:d.getAsJson(),eventType:h},"UNDEFINED_CSN"==e?cv("visualElementHidden",d,f):b?pr("visualElementHidden",d,b,f):sm("visualElementHidden",
d,f)));a.i[a.i.length-1]&&!a.i[a.i.length-1].csn&&(a.i[a.i.length-1].csn=k||"");su({clientScreenNonce:k});dv.getInstance().clear();d=ks(c.layer);e&&"UNDEFINED_CSN"!==e&&d&&(M("web_mark_root_visible")||M("music_web_mark_root_visible"))&&(e=k,k={cttAuthInfo:os(e),ba:e},M("il_via_jspb")?(b=new Fj,b.V(e),f=d.getAsJspb(),G(b,rj,2,f),D(b,4,1),"UNDEFINED_CSN"==e?cv("visualElementShown",b,k):vr(b,k)):(b={csn:e,ve:d.getAsJson(),eventType:1},"UNDEFINED_CSN"==e?cv("visualElementShown",b,k):sm("visualElementShown",
b,k)));a.j.delete(c.layer||0);a.l=void 0;e=p(a.A);for(k=e.next();!k.done;k=e.next())b=p(k.value),k=b.next().value,b=b.next().value,b.has(c.layer)&&d&&gv(a,k,d,c.layer);for(c=0;c<a.m.length;c++){e=a.m[c];try{e()}catch(m){Ur(m)}}for(c=a.m.length=0;c<a.B.length;c++){e=a.B[c];try{e()}catch(m){Ur(m)}}}
;function jv(){var a,b;return w(function(c){if(1==c.i)return a=gt().resolve(Gu),a?v(c,Bu(a),2):(Vr(Error("InnertubeTransportService unavailable in fetchDatasyncIds")),c.return(void 0));if(b=c.j)return b.errorMetadata?(Vr(Error("Datasync IDs fetch responded with "+b.errorMetadata.status+": "+b.error)),c.return(void 0)):c.return(b.Hq);Vr(Error("Network request to get Datasync IDs failed."));return c.return(void 0)})}
;var kv=y.caches,lv;function mv(a){var b=a.indexOf(":");return-1===b?{ac:a}:{ac:a.substring(0,b),datasyncId:a.substring(b+1)}}
function nv(){return w(function(a){if(void 0!==lv)return a.return(lv);lv=new Promise(function(b){var c;return w(function(d){switch(d.i){case 1:return ya(d,2),v(d,kv.open("test-only"),4);case 4:return v(d,kv.delete("test-only"),5);case 5:za(d,3);break;case 2:if(c=Aa(d),c instanceof Error&&"SecurityError"===c.name)return b(!1),d.return();case 3:b("caches"in window),d.i=0}})});
return a.return(lv)})}
function ov(a){var b,c,d,e,f,g,h;w(function(k){if(1==k.i)return v(k,nv(),2);if(3!=k.i){if(!k.j)return k.return(!1);b=[];return v(k,kv.keys(),3)}c=k.j;d=p(c);for(e=d.next();!e.done;e=d.next())f=e.value,g=mv(f),h=g.datasyncId,!h||a.includes(h)||b.push(kv.delete(f));return k.return(Promise.all(b).then(function(m){return m.some(function(q){return q})}))})}
function pv(){var a,b,c,d,e,f,g;return w(function(h){if(1==h.i)return v(h,nv(),2);if(3!=h.i){if(!h.j)return h.return(!1);a=wm("cache contains other");return v(h,kv.keys(),3)}b=h.j;c=p(b);for(d=c.next();!d.done;d=c.next())if(e=d.value,f=mv(e),(g=f.datasyncId)&&g!==a)return h.return(!0);return h.return(!1)})}
...
function tv(){if(!qv())return!1;var a=wm(),b=Object.keys(window.localStorage);b=p(b);for(var c=b.next();!c.done;c=b.next())if(c=rv(c.value),void 0!==c&&c!==a)return!0;return!1}
;function uv(){jv().then(function(a){a&&(Hn(a),ov(a),sv(a))})}
function vv(){var a=new Ro;Vh.S(function(){var b,c,d,e;return w(function(f){switch(f.i){case 1:if(M("ytidb_clear_optimizations_killswitch")){f.u(2);break}b=wm("clear");if(b.startsWith("V")){var g=[b];Hn(g);ov(g);sv(g);return f.return()}c=tv();return v(f,pv(),3);case 3:return d=f.j,v(f,In(),4);case 4:if(e=f.j,!c&&!d&&!e)return f.return();case 2:a.L()?uv():a.m.add("publicytnetworkstatus-online",uv,!0,void 0,void 0),f.i=0}})})}
...
function Dv(a,b,c){c=void 0===c?null:c;var d=Ev(a),e=document.getElementById(d),f=e&&yv(e,"loaded"),g=e&&!f;f?b&&b():(b&&(f=zq(d,b),b=""+Ra(b),Fv[b]=f),g||(e=Gv(a,d,function(){yv(e,"loaded")||(wv(e),Cq(d),el(Xa(Dq,d),0))},c)))}
function Gv(a,b,c,d){d=void 0===d?null:d;var e=hf("SCRIPT");e.id=b;e.onload=function(){c&&setTimeout(c,0)};
...
function Hv(a){a=Ev(a);var b=document.getElementById(a);b&&(Dq(a),b.parentNode.removeChild(b))}
function Iv(a,b){a&&b&&(a=""+Ra(b),(a=Fv[a])&&Bq(a))}
function Ev(a){var b=document.createElement("a");fc(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+kc(a)}
var Fv={};var Jv=[],Kv=!1;function Lv(){if(!M("disable_biscotti_fetch_for_ad_blocker_detection")&&!M("disable_biscotti_fetch_entirely_for_all_web_clients")&&Cs()){var a=L("PLAYER_VARS",{});if("1"!=tb(a)&&!Ds(a)){var b=function(){Kv=!0;"google_ad_status"in window?Ck("DCLKSTAT",1):Ck("DCLKSTAT",2)};
try{Cv("//static.doubleclick.net/instream/ad_status.js",b)}catch(c){}Jv.push(Vh.S(function(){if(!(Kv||"google_ad_status"in window)){try{Iv("//static.doubleclick.net/instream/ad_status.js",b)}catch(c){}Kv=!0;Ck("DCLKSTAT",3)}},5E3))}}}
function Mv(){var a=Number(L("DCLKSTAT",0));return isNaN(a)?0:a}
;function Nv(){this.state=1;this.i=null}
l=Nv.prototype;
l.initialize=function(a,b,c){if(a.program){var d,e=null!=(d=a.interpreterScript)?d:null,f;d=null!=(f=a.interpreterUrl)?f:null;a.interpreterSafeScript&&(e=a.interpreterSafeScript,Db("From proto message. b/166824318"),e=e.privateDoNotAccessOrElseSafeScriptWrappedValue||"",e=(f=Ab())?f.createScript(e):e,e=(new Fb(e)).toString());a.interpreterSafeUrl&&(d=a.interpreterSafeUrl,Db("From proto message. b/166824318"),d=Lb(d.privateDoNotAccessOrElseTrustedResourceUrlWrappedValue||"").toString());Qv(this,e,
d,a.program,b,c)}else Vr(Error("Cannot initialize botguard without program"))};
function Qv(a,b,c,d,e,f){var g=void 0===g?"trayride":g;c?(a.state=2,Cv(c,function(){window[g]?Rv(a,d,g,e):(a.state=3,Hv(c),Vr(new Q("Unable to load Botguard","from "+c)))},f)):b?(f=hf("SCRIPT"),f.textContent=b,f.nonce=ic(),document.head.appendChild(f),document.head.removeChild(f),window[g]?Rv(a,d,g,e):(a.state=4,Vr(new Q("Unable to load Botguard from JS")))):Vr(new Q("Unable to load VM; no url or JS provided"))}
l.isInitialized=function(){return!!this.pb()};
function Rv(a,b,c,d){a.state=5;try{var e=new Ah({program:b,globalName:c});e.jd.then(function(){a.state=6;d&&d(b)});
...
l.zb=function(a){ne(this.i);this.i=a};function Sv(){Nv.apply(this,arguments)}
t(Sv,Nv);Sv.prototype.Db=function(){this.state=8};
Sv.prototype.pb=function(){return B("yt.abuse.playerAttLoader")};
Sv.prototype.zb=function(a){ne(B("yt.abuse.playerAttLoader"));z("yt.abuse.playerAttLoader",a)};var Tv=new Sv;var Uv=new Nv;function Vv(){return M("use_player_abuse_bg_library")?Tv.isInitialized():Uv.isInitialized()}
...
var fw;t(ew,dw);ew.prototype.m=function(){if(M("web_fp_via_jspb")){var a=new qj,b=ms();b&&a.V(b);b=new Qj;Xd(b,qj,380,Rj,a);ur(b);M("web_fp_via_jspb_and_json")&&sm("finalPayload",{csn:ms()})}else sm("finalPayload",{csn:ms()})};
ew.prototype.l=function(){Zr($r)};function gw(){}
...
function Dw(a){var b=Ew(a),c=document.getElementById(b),d=c&&yv(c,"loaded");d||c&&!d||(c=Fw(a,b,function(){yv(c,"loaded")||(wv(c),Cq(b),el(Xa(Dq,b),0))}))}
...
function Qw(a){var b=!0,c=Rw(a);c&&a.config&&(a=Sw(a),b=yv(c,"version")===a);return b&&!!B("yt.player.Application.create")}
...
a.P=!0;b?a.G():(Cv(Sw(a),a.G),(b=Ww(a))&&Cw(b),Xw(a)&&!c&&z("yt.player.Application.create",null))}}}
...
function Zw(a,b,c){var d=b[c];return function(){var e=Ja.apply(0,arguments);try{return a.lastError=null,d.apply(b,e)}catch(f){"sendAbandonmentPing"!==c&&(f.params=c,a.lastError=f,Vr(f))}}}
...
function Pw(a,b){var c=b;if("string"===typeof b){if(a.la[b])return a.la[b];c=function(){var d=Ja.apply(0,arguments),e=B(b);if(e)try{e.apply(y,d)}catch(f){Ur(f)}};
a.la[b]=c}return c?c:null}
function $w(a,b){var c="ytPlayer"+b+a.A;a.j[b]=c;y[c]=function(d){var e=el(function(){if(!a.i()){try{a.K.qa(b,null!=d?d:void 0)}catch(h){Vr(new Q("PlayerProxy error when creating global callback",{error:h,event:b,playerId:a.A,data:d}))}var f=a.J,g=String(e);g in f&&delete f[g]}},0);
sb(a.J,String(e))};
return c}
...
l.cancel=function(){this.G&&Iv(Sw(this),this.G);fl(this.Da);this.P=!1};
l.D=function(){Uw(this);if(this.m&&this.config&&this.m.destroy)try{this.m.destroy()}catch(b){Ur(b)}this.la=null;for(var a in this.j)this.j.hasOwnProperty(a)&&(y[this.j[a]]=null);this.ra=this.config=this.api=null;delete this.o;delete this.l;J.prototype.D.call(this)};
...
function kx(){ex&&ex.sendAbandonmentPing&&ex.sendAbandonmentPing();L("PL_ATT")&&(M("use_player_abuse_bg_library")?Tv.dispose():Uv.dispose());for(var a=Vh,b=0,c=Jv.length;b<c;b++)a.fa(Jv[b]);Jv.length=0;Hv("//static.doubleclick.net/instream/ad_status.js");Kv=!1;Ck("DCLKSTAT",0);oe(gx,fx);ex&&(ex.removeEventListener("onVideoDataChange",hx),ex.destroy())}
;function lx(a,b,c){a="ST-"+kc(a).toString(36);b=b?tc(b):"";c=c||5;Cs()&&vl(a,b,c)}
...
z("writeEmbed",function(){var a=L("PLAYER_CONFIG");if(!a){var b=L("PLAYER_VARS");b&&(a={args:b})}Ms(!0);"gvn"===a.args.ps&&(document.body.style.backgroundColor="transparent");a.attrs||(a.attrs={width:"100%",height:"100%",id:"video-player"});var c=document.referrer;b=L("POST_MESSAGE_ORIGIN");window!==window.top&&c&&c!==document.URL&&(a.args.loaderUrl=c);M("embeds_js_api_set_1p_cookie")&&(c=Xk(window.location.href),c.embedsTokenValue&&(a.args.embedsTokenValue=c.embedsTokenValue));mu();if((c=L("WEB_PLAYER_CONTEXT_CONFIGS"))&&
...
a,b),gx=new ww(ex,fx.connection));Lv();M("ytidb_create_logger_embed_killswitch")||pm();a={};fw||(fw=new ew);fw.install((a.flush_logs={callback:function(){Wq()}},a));
M("embeds_web_enable_new_nwl")?Yo():fp();M("ytidb_clear_embedded_player")&&Vh.S(function(){var e;if(!Vu){var f=gt(),g={wb:Uu,nc:Tu};f.providers.set(g.wb,g);g={Mb:{feedbackEndpoint:ht(Pu),modifyChannelNotificationPreferenceEndpoint:ht(Qu),playlistEditEndpoint:ht(Ru),subscribeEndpoint:ht(Nu),unsubscribeEndpoint:ht(Ou),webPlayerShareEntityServiceEndpoint:ht(Su)}};var h=M("web_enable_client_location_service")?Vs.getInstance():void 0,k={};h&&(k.client_location=h);if(void 0===m){Ns.i||(Ns.i=new Ns);var m=
Ns.i}void 0===e&&(e=f.resolve(Uu));Au(g,e,m,k);m={wb:Gu,oc:zu.i};f.providers.set(m.wb,m);Vu=f.resolve(Gu)}vv()})});
var nx=Kk(function(){tu();var a=zl.getInstance(),b=Cl(119),c=1<window.devicePixelRatio;if(document.body&&gi(document.body,"exp-invert-logo"))if(c&&!gi(document.body,"inverted-hdpi")){var d=document.body;if(d.classList)d.classList.add("inverted-hdpi");else if(!gi(d,"inverted-hdpi")){var e=ei(d);fi(d,e+(0<e.length?" inverted-hdpi":"inverted-hdpi"))}}else!c&&gi(document.body,"inverted-hdpi")&&hi();if(b!=c){b="f"+(Math.floor(119/31)+1);d=Dl(b)||0;d=c?d|67108864:d&-67108865;0==d?delete yl[b]:(c=d.toString(16),
yl[b]=c.toString());c=!0;M("web_secure_pref_cookie_killswitch")&&(c=!1);b=a.i;d=[];for(var f in yl)d.push(f+"="+encodeURIComponent(String(yl[f])));vl(b,d.join("&"),63072E3,a.j,c)}ev.i||(ev.i=new ev);a=ev.i;f=16623;var g=void 0===g?{}:g;Object.values(ss).includes(f)||(Vr(new Q("createClientScreen() called with a non-page VE",f)),f=83769);g.isHistoryNavigation||a.i.push({rootVe:f,key:g.key||""});a.o=[];a.N=[];g.Pb?hv(a,f,g):iv(a,f,g)}),ox=Kk(function(a){M("embeds_web_enable_dispose_player_if_page_not_cached_killswitch")?
kx():a.persisted||kx()}),px=Kk(kx);
window.addEventListener?(window.addEventListener("load",nx),window.addEventListener("pagehide",ox)):window.attachEvent&&(window.attachEvent("onload",nx),window.attachEvent("onunload",px));z("yt.abuse.player.botguardInitialized",B("yt.abuse.player.botguardInitialized")||Vv);z("yt.abuse.player.invokeBotguard",B("yt.abuse.player.invokeBotguard")||Wv);z("yt.abuse.dclkstatus.checkDclkStatus",B("yt.abuse.dclkstatus.checkDclkStatus")||Mv);z("yt.player.exports.navigate",B("yt.player.exports.navigate")||mx);
